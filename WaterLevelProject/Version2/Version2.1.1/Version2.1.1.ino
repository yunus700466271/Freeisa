...
void setPassword() {
  ...
  if (tempStr == settingsPassword) {
    delay(200);
    String pass1 = getText("Enter New password:");
    delay(200);
    String pass2 = getText("Confirm password:");
    if (pass1 == pass2) {
      tft.fillRectangle(0 , 0, 176, 220, background_color); //set background
      setText(0, 100, "password Changed!", false);
      delay(1000);
      settingsPassword = pass1;
      storeValue("settingsPassword",settingsPassword,2000);
      advanced();
    }
    else {
...
void init_() {
  ...
  settingsPassword =getValue("settingsPassword",settingsPassword,2000);
}
